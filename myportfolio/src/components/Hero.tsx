        ...
        <section>
            ...
            <div className="w-screen relative lg:hidden">
                <img
                    ...
                    alt="background"
                />
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white mt-30 px-6">
                    ...
                    <img
                        className="mt-[14px] w-[142px] h-[10px] sm:w-[180px] sm:h-[12px]"
                        src="/separatorWhite.png"
                        alt="separator"
                    />
                    <div className="mt-[14px] flex gap-5 sm:gap-6">
                        <MobileSocialIcon>
                    ...
                    <a
                        href="#about"
                        className="mt-30 text-white transition-transform duration-300 hover:scale-110 hover:text-orange-400 active:scale-95"
                    >
            ...
            <div className="hidden lg:block relative h-screen w-full overflow-hidden">
                ...
                <div className="relative z-10 h-full">
                    <a
                        href="#"
                        className="absolute top-8 left-8 xl:top-10 xl:left-14 2xl:top-12 2xl:left-20 block transition-transform duration-300 hover:scale-105 active:scale-95"
                    >
                        <img
                            src="/mylogo.png"
                            alt="Logo"
                    ...
                    <nav className="absolute top-8 right-8 xl:top-10 xl:right-14 2xl:top-12 2xl:right-20 flex items-center gap-6 xl:gap-10 2xl:gap-12 text-lg xl:text-xl 2xl:text-2xl min-[1920px]:text-[1.75rem]">
                        ...
                        <a
                            href="#contact"
                            className="bg-white text-black font-bold px-5 py-2 rounded-full text-base xl:px-7 xl:py-3 xl:text-lg 2xl:px-9 2xl:py-3.5 2xl:text-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_24px_rgba(255,255,255,0.35)] active:scale-95"
                        >
                            CONTACT ME
                        </a>
                    </nav>
                    ...
                    <div className="absolute right-0 top-0 bottom-0 w-[55%] flex items-end justify-center pointer-events-none px-4">
                        {/* Adicione sua foto aqui:
                        <img
                            src="/sua-foto.png"
                            alt="Gabriel Sousa"
                            className="max-h-[80vh] xl:max-h-[85vh] 2xl:max-h-[88vh] w-auto object-contain object-bottom"
                        />
                        */}
                    </div>
                </div>
...
function MobileSocialIcon({ children }: { children: ReactNode }) {
    return (
        <button
            type="button"
            className="text-white cursor-pointer transition-all duration-300 hover:scale-110 hover:text-orange-400 active:scale-95"
        >
            {children}
        </button>
    );
